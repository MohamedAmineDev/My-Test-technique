 ...
 */
final class Version20230913171532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', sales_order_line_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', description LONGTEXT NOT NULL, unit_code VARCHAR(255) NOT NULL, unit_price DOUBLE PRECISION NOT NULL, vat_amount DOUBLE PRECISION NOT NULL, vat_percentage DOUBLE PRECISION NOT NULL, INDEX IDX_23A0E667E27AABA (sales_order_line_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sales_order_line (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', the_order_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', amount DOUBLE PRECISION NOT NULL, discount DOUBLE PRECISION NOT NULL, quantity INT NOT NULL, unit_description LONGTEXT NOT NULL, INDEX IDX_93D9398DC416F85B (the_order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', available_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', delivered_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_75EA56E0FB7336F0 (queue_name), INDEX IDX_75EA56E0E3BD61CE (available_at), INDEX IDX_75EA56E016BA31DB (delivered_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_23A0E667E27AABA FOREIGN KEY (sales_order_line_id) REFERENCES sales_order_line (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP FOREIGN KEY FK_23A0E667E27AABA');
