 ...
 */
final class Version20230915210320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', deliver_to_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', amount DOUBLE PRECISION NOT NULL, currency VARCHAR(255) NOT NULL, order_number BIGINT DEFAULT NULL, INDEX IDX_F52993986D7914CF (deliver_to_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
